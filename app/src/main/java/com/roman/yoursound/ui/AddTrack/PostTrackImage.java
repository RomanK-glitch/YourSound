...
public class PostTrackImage extends AsyncTask<String, Void, String> {

    String result = "";
    String trackImagePath, newFileNameId;
    int serverResponseCode = 0;
    AddTrackActivity addTrackActivity;

    public PostTrackImage(String trackImagePath, AddTrackActivity addTrackActivity, String newFileNameId){
    ...
    protected String doInBackground(String... strings) {
        ...
        try {
            ...
            String sourceFileUri = trackImagePath;
            ...
            if (sourceFile.isFile()) {
                ...
                try {
                    ...
                    URL url = new URL("http://mrkoste6.beget.tech/upload_track_image.php");
