...
public class PostFollow extends AsyncTask<String, Void, String> {
    String result = "";
    int currentUserId;
    UserFragment userFragment;

    public PostFollow(int currentUserId, UserFragment userFragment){
    ...
    protected String doInBackground(String... strings) {
        try {
            URL url = new URL("http://mrkoste6.beget.tech/follow.php");
